...
const LandingPage2 = ({ navigation }) => {
  const navigateToNextPage = () => {
    navigation.navigate('LandingPage3'); // Navigate to the next page
  };
      ...
      <View style={styles.content}>
        <View style={styles.contentHeader}>
          <Text style={styles.title}>
            Advanced Budgeting Suite
          </Text>
          <Text style={styles.text}>
          Enhance budgeting efficiency to navigate financial challenges and achieve goals with precision
          </Text>
        </View>

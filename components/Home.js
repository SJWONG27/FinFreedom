      ...
      <ScrollView>
        <View style={homeStyle.container2}>
          <View style={homeStyle.container3}>
            ...
            <Pressable style={{ marginLeft: 50 }} onPress={() => navigation.navigate('Points')}>
          ...
          <View style={homeStyle.chart1}>
            <Svg style={{ marginTop: -20, marginBottom: -20 }}
            ...
            >
              ...
              <Defs>
                ...
                >
                  <Stop stopColor="#fff" stopOpacity={0.522} />
                  <Stop offset={1} stopColor="#333340" stopOpacity={0.01} />
                </LinearGradient>
                <LinearGradient
                  id="c"
                  x1={157.5}
                ...
                <ClipPath id="a">
                  <Path fill="#fff" d="M0 0h316v353H0z" />
                </ClipPath>
              </Defs>
            </Svg>
          </View>
          <View style={homeStyle.container6}>
            <Text style={{ fontWeight: 'bold', color: 'lightblue', textAlign: 'center', backgroundColor: 'blue', borderRadius: 10, fontSize: 18, }}>March 2024</Text>
            <Text style={homeStyle.message5}>Income: <Text style={homeStyle.boldText}>RM {income.toFixed(2)}</Text></Text>
            <Text style={homeStyle.message5}>Expenses: <Text style={homeStyle.boldText}>RM {expenses.toFixed(2)}</Text></Text>
            <Text style={homeStyle.message5}>Balance: <Text style={homeStyle.boldText}>{balance >= 0 ? 'RM ' + balance.toFixed(2) : 'Negative Balance'}</Text></Text>
            <Pressable
              style={[homeStyle.button, !isPremiumUser && homeStyle.disabledButton]}
              onPress={isPremiumUser ? handleAIBudgetSuggestion : () => { }}
...
const homeStyle = StyleSheet.create({
  ...
  button: {
    borderRadius: 10,
    backgroundColor: 'darkblue', // You can change this color to your preference
    padding: 10,
    marginTop: 10,
    flexDirection: 'row',
    alignItems: 'center',

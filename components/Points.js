...
<View style={pointStyle.chart1}>
<Svg style={{margin:30, maxHeight: 500 }}
    ...
    // {...props}
  >
    <Rect width={315} height={331} x={1} fill="transparent" rx={12} />
    <Path
      stroke="#000000"
    ...
    <Defs>
      ...
      <ClipPath id="a">
        <Path fill="#000000" d="M51 162.25h237v88H51z" />
      </ClipPath>
    </Defs>
  </Svg>
  </View>
